...
export const resetRoom = async (room: string) =>
  ipcRenderer.invoke(IpcChannels.RESET_ROOM, room);

export const deleteProductFromRoom = async (
  roomId: string,
  productId: string
) =>
...
export const updateProductInRoom = async (
  roomId: string,
  product: Saled_Product_Type
) =>
